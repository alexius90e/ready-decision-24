const proektyV5CardSliders = document.querySelectorAll('.proekty-v-5__card-sliders');

proektyV5CardSliders.forEach((slidersElem) => {
  const baseClassName = '.proekty-v-5__card-sliders';
...
const proektyV5Modal = document.querySelector('.proekty-v-5__modal');
const proektyV5ModalForm = document.querySelector('.proekty-v-5__modal-form');
const proektyV5ContactButtons = document.querySelectorAll(
  '.proekty-v-5__card-content-contact-button'
);
...
if (proektyV5Modal && proektyV5ModalForm) {
  ...
  proektyV5Modal.addEventListener('click', (event) => {
    ...
    const isClose = event.target.classList.contains('proekty-v-5__modal-close-button');
...
const proektyV5More = document.querySelector('.proekty-v-5__more');

if (proektyV5More) {
  proektyV5More.addEventListener('click', (event) => {
    const isButton = event.target.classList.contains('proekty-v-5__more-button');

    if (isButton) {
      const hiddenCards = document.querySelectorAll('.proekty-v-5__card.hidden');
