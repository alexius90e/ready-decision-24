const headerModal = document.querySelector('.header-v-2__modal');
const headerModalForm = document.querySelector('.header-v-2__modal-form');
const headerCallbackButtons = document.querySelectorAll('.header-v-2__contacts-callback-button');
const headerCallbackMobButtons = document.querySelectorAll(
  '.header-v-2__menu-mobile-contacts-callback-button'
);
...
if (headerModal && headerModalForm) {
  ...
  headerModal.addEventListener('click', (event) => {
    ...
    const isClose = event.target.classList.contains('header-v-2__modal-close-button');
